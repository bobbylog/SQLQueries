SELECT DISTINCT 
               ...
               CAMS_RptStudentAddressList_View.FirstName, CAMS_RptStudentAddressList_View.StudentID
...
WHERE (CAMS_RptSROfferType1000_View.SemesterID = 610) AND (CAMS_RptRoster_View.TextTerm = 'SU-16')