...
SELECT ST1.StudentUID, ST1.StudentID, ST1.LastName,  ST1.FirstName, TC1.TextTerm, MM1.MajorMinorName, SP1.SequenceNo, 
...
GROUP BY ST1.STUDENTUID, ST1.StudentID, ST1.LastName, ST1.FirstName ,TC1.TextTerm, MM1.MajorMinorName, SP1.SequenceNo, GL3.DisplayText, GL4.DisplayText
...
SELECT GS14.StudentUID, GS14.StudentID, GS14.LastName, GS14.FirstName, GS14.TextTerm, GS14.MajorMinorName, GS14.SequenceNo, 
...
--        FROM #PStudents PS6 
--        WHERE PS6.MajorMinorName = PS.MajorMinorName AND PS6.SCRED < 12 AND PS6.STUSD = 'YEA' AND NOT PS6.Tracking = 'Lancaster HS') AS PTHSCNT,
--       (SELECT COUNT(PS7.StudentID) 
--        FROM #PStudents PS7 
--        WHERE PS7.MajorMinorName = PS.MajorMinorName AND PS7.SCRED > 11 AND PS7.STUSD = 'YEA' AND NOT PS7.Tracking = 'Lancaster HS') AS FTHSCNT, 
--       (SELECT COUNT(PS8.StudentID) 
--        FROM #PStudents PS8 
--        WHERE PS8.MajorMinorName = PS.MajorMinorName AND PS8.SCRED < 12 AND PS8.STUSD = 'YEA' AND PS8.Tracking = 'Lancaster HS') AS PTHSLCNT,
--       (SELECT COUNT(PS9.StudentID) 
--        FROM #PStudents PS9 
--        WHERE PS9.MajorMinorName = PS.MajorMinorName AND PS9.SCRED > 11 AND PS9.STUSD = 'YEA' AND PS9.Tracking = 'Lancaster HS') AS FTHSLCNT, 
...
--                          R2.FT0CNT - R2.FTHSCNT - R2.FTHSLCNT  AS FT, 
--                          R2.PT0CNT - R2.PTHSCNT - R2.PTHSLCNT  AS PT, 
--                          R2.FT0CNT + R2.PT0CNT - R2.FTHSCNT - R2.PTHSCNT - R2.FTHSLCNT - R2.PTHSLCNT AS Total, 
--                          R2.FT1CNT AS FT_DM, 
--                          R2.PT1CNT AS PT_DM, 
--                          R2.PTHSCNT AS PT_HS, 
--                          R2.FTHSCNT AS FT_HS,
