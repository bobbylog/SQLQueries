...
into #tmptab
from Trocaire_Extra.dbo.Troc_Term_Snapshots_Drop_Add1
...
select  distinct studentid, Lastname, firstname, DegreeProgram, sequenceNo from Trocaire_Extra.dbo.Troc_Term_Snapshots_Drop_Add1
where studentid in(
...
--update Trocaire_Extra.dbo.Troc_Term_Snapshots_Drop_Add1
