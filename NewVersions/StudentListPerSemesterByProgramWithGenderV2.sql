...
SELECT DISTINCT 
               ...
               AS FirstName, ST1.MiddleInitial
			   ,(select top 1 A.Gender from StudentDemographics A where A.StudentUID=St1.Studentuid) as Gender
			   ,MM1.MajorMinorName AS DegreeProgram, LTRIM(RTRIM(ST1.LastName)) + SUBSTRING(LTRIM(RTRIM(ST1.FirstName)), 1, 1) 
...
select Term, StudentID, LastName,FirstName, MiddleInitial, Gender, DegreeProgram, Email1 from #NewStud
where DegreeProgram in('Nursing', 'Nursing - BS')
and Gender='Male'
