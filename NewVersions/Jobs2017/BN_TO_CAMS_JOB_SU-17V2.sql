...
/****** Object:  Job [BN_TO_CAMS_JOB_SU-17]    Script Date: 05/24/2017 18:22:23 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 05/24/2017 18:22:24 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 05/24/2017 18:22:24 ******/
				...
				if (@nc > 0)
					begin
						...
						begin
											...
											set @tbody= ''Dear Barnes and Nobles, ''+CHAR(13)+CHAR(13)+CHAR(10)+''We have not received a transaction file today. Please, contact Senghor Etienne at etiennes@trocaire.edu if this the result of a transmission error. Disregards this message otherwise. '' +
