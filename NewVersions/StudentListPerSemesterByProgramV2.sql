SELECT DISTINCT 
               ...
               AS USERID, dbo.getStudentEmailAddressFromID(ST1.StudentID) as Email1,  dbo.isNewStudentByTerm(st1.StudentID,'fa-17') as NewS1 
...
and MM1.MajorMinorName like 'surgical%'
AND NOT SR1.grade='W'
