...
/****** Object:  Job [Sem_SnapShot_Job_FA-17]    Script Date: 8/14/2017 10:40:32 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/14/2017 10:40:32 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 8/14/2017 10:40:32 AM ******/
...
If (MONTH(@dt)=10 and DAY(@dt)=30 aND YEAR(@dt)=2017)
BEGIN
