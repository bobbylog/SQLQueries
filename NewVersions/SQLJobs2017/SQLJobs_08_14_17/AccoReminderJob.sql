...
/****** Object:  Job [AccoReminderJob]    Script Date: 8/14/2017 10:27:51 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/14/2017 10:27:51 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'AccoReminderJob', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 8/14/2017 10:27:51 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'AccoSched', 
		@enabled=1, 
		@freq_type=4, 
		@freq_interval=1, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'7c8954c3-dc6c-41a4-84c5-1e471d8d1a22'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
