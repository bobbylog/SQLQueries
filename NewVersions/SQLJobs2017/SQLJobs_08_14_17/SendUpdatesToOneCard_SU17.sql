...
/****** Object:  Job [SendUpdatesToOneCard_SU17]    Script Date: 8/14/2017 10:41:19 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/14/2017 10:41:19 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'SendUpdatesToOneCard_SU17', 
		@enabled=0, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 8/14/2017 10:41:19 AM ******/
...
AND (TermCalendarID = 615)  
AND ExpectedTermSeq Between ''B17C'' AND ''B17L'' 
