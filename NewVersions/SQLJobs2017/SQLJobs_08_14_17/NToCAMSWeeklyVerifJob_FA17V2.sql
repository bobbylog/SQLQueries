...
/****** Object:  Job [BNToCAMSWeeklyVerifJob_FA17]    Script Date: 8/18/2017 11:38:49 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/18/2017 11:38:49 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'BNToCAMSWeeklyVerifJob_FA17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 8/18/2017 11:38:49 AM ******/
