...
/****** Object:  Job [SendUpdatesToOneCard_FA17]    Script Date: 8/14/2017 10:41:03 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/14/2017 10:41:03 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 8/14/2017 10:41:03 AM ******/
...
set @tbody= ''Dear HelpDesk, ''+CHAR(13)+CHAR(13)+CHAR(10)+''The OneCard System has been updated today ''+'' as of ''+LEFT(CONVERT(VARCHAR, GETDATE(), 120), 10)+
...
@recipients = ''daroisb@trocaire.edu;loomisr@trocaire.edu;ziadalm@advance2000.com;etiennes@trocaire.edu'', 
