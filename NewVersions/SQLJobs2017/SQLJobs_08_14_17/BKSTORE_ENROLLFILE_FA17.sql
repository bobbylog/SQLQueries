...
/****** Object:  Job [BKSTORE_ENROLLFILE_FA17]    Script Date: 8/14/2017 10:30:51 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/14/2017 10:30:51 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'BKSTORE_ENROLLFILE_FA17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [ProcessingFile]    Script Date: 8/14/2017 10:30:51 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ENRSCHED', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=2, 
		@freq_subday_type=1, 
		...
		@schedule_uid=N'7ee6fccc-a541-44a2-a87f-bc4c0a4a848b'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
