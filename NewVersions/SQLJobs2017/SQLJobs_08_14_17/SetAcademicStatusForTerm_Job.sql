...
/****** Object:  Job [SetAcademicStatusForTerm_Job]    Script Date: 12/29/2017 10:19:04 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 12/29/2017 10:19:04 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'SetAcademicStatusForTerm_Job', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 12/29/2017 10:19:04 AM ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Processing', 
		...
		@command=N'DECLARE @endd datetime
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ACASETSCHED', 
		@enabled=1, 
		@freq_type=8, 
		@freq_interval=62, 
		@freq_subday_type=1, 
		...
		@active_start_date=20171229, 
		@active_end_date=99991231, 
		@active_start_time=220000, 
		@active_end_time=235959, 
		@schedule_uid=N'9fe87666-0869-4470-ae41-27d1fd868513'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
