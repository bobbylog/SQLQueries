...
/****** Object:  Job [Generate_Accepted_Students_FA17]    Script Date: 8/14/2017 10:36:01 AM ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 8/14/2017 10:36:01 AM ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'Generate_Accepted_Students_FA17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 8/14/2017 10:36:01 AM ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'ACCEPTSCHED', 
		@enabled=0, 
		@freq_type=8, 
		@freq_interval=62, 
		@freq_subday_type=1, 
		...
		@active_end_date=20170422, 
		@active_start_time=90000, 
		@active_end_time=235959, 
		@schedule_uid=N'0160455a-e852-4e12-aa2c-01b1db9e381d'
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
