...
/****** Object:  Job [GENERATE_ADIMPORT_SP17]    Script Date: 02/10/2017 15:45:02 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 02/10/2017 15:45:02 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'GENERATE_ADIMPORT_SP17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [GenerateAD]    Script Date: 02/10/2017 15:45:02 ******/
