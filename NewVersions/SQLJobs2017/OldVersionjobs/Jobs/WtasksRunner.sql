...
/****** Object:  Job [WtasksRunner]    Script Date: 03/07/2017 11:28:59 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 03/07/2017 11:28:59 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 03/07/2017 11:28:59 ******/
EXEC @ReturnCode = msdb.dbo.sp_add_jobstep @job_id=@jobId, @step_name=N'Processing', 
		...
		@command=N'-- EXEC  master..xp_cmdshell ''schtasks /run /tn Testscr''
