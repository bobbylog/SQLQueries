...
/****** Object:  Job [ENSSTUDENTS_SP17]    Script Date: 02/10/2017 15:44:17 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 02/10/2017 15:44:17 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'ENSSTUDENTS_SP17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [Processing]    Script Date: 02/10/2017 15:44:17 ******/
...
set @tbody= ''Dear Nick, ''+CHAR(13)+CHAR(13)+CHAR(10)+''Please, find Attached Student List File for ''+@cterm+ '' as of ''+LEFT(CONVERT(VARCHAR, GETDATE(), 120), 10)+
