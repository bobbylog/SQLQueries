...
/****** Object:  Job [GENERATE_ADIMPORT_FA17]    Script Date: 07/20/2017 15:45:15 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 07/20/2017 15:45:15 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'GENERATE_ADIMPORT_FA17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [GenerateAD]    Script Date: 07/20/2017 15:45:15 ******/
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
EXEC @ReturnCode = msdb.dbo.sp_add_jobschedule @job_id=@jobId, @name=N'STUACCSCHED', 
		@enabled=0, 
		@freq_type=8, 
		@freq_interval=62, 
		@freq_subday_type=1, 
