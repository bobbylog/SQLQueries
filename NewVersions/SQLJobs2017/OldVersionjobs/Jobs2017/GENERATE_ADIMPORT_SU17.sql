...
/****** Object:  Job [GENERATE_ADIMPORT_SU17]    Script Date: 05/12/2017 14:19:46 ******/
BEGIN TRANSACTION
DECLARE @ReturnCode INT
SELECT @ReturnCode = 0
/****** Object:  JobCategory [[Uncategorized (Local)]]]    Script Date: 05/12/2017 14:19:46 ******/
...
EXEC @ReturnCode =  msdb.dbo.sp_add_job @job_name=N'GENERATE_ADIMPORT_SU17', 
		@enabled=1, 
...
IF (@@ERROR <> 0 OR @ReturnCode <> 0) GOTO QuitWithRollback
/****** Object:  Step [GenerateAD]    Script Date: 05/12/2017 14:19:46 ******/
