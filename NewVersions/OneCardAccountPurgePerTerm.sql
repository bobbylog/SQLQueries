...
/*'SU-13','FA-13','SP-14','SU-14','FA-14', 'FA-BSN-13', 'FA-BSN-14', 'SP-15', 'SU-15', 'FA-15'*/
/********************************************************************/
...
WHERE DisplayTerm IN ('SU-12', 'FA-12', 'FA-BSN-12', 'SP-12','SP-13','SU-13','FA-13','SP-14','SU-14','FA-14', 'FA-BSN-13', 'FA-BSN-14', 'SP-15','SU-15','FA-15')
...
SELECT *
INTO OneCard.dbo.DELETES080817
FROM OneCard.onecard2.ACCOUNTS
WHERE CUSTOM IN (SELECT CUSTOM FROM #Delete)
