...
set @t=dbo.getTermID(@CTerm)
	...
	dbo.getStudentNextEnrolledStatusID(dbo.CAMS_StudentStatus_View.StudentUID) as NEnrStatusID
		...
		WHERE (dbo.TermCalendar.ActiveFlag = 'True') AND (dbo.TermCalendar.TextTerm ='sp-17')and dbo.CAMS_StudentStatus_View.StudentUID in
		(
		...
		WHERE (CAMS_RptSROfferType1000_View.TextTerm IN ('sp-17'))
